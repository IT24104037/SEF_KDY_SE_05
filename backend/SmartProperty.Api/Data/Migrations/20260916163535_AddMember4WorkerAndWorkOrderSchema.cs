...
{
    /// <inheritdoc />
    public partial class AddMember4WorkerAndWorkOrderSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalDecisions_MaintenanceRequests_MaintenanceRequestId",
                        column: x => x.MaintenanceRequestId,
                        principalTable: "MaintenanceRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApprovalDecisions_PropertyOwners_PropertyOwnerId",
            ...
            migrationBuilder.CreateTable(
                name: "ExternalMaintenanceArrangements",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ...
                    ScheduledDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    EstimatedArrival = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExternalMaintenanceArrangements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExternalMaintenanceArrangements_MaintenanceRequests_Mainten~",
                        column: x => x.MaintenanceRequestId,
                        principalTable: "MaintenanceRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Workers_Users_VerifiedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceAreas_Workers_WorkerId",
                        column: x => x.WorkerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ValidationResults_MaintenanceRequests_MaintenanceRequestId",
                        column: x => x.MaintenanceRequestId,
                        principalTable: "MaintenanceRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ValidationResults_Workers_WorkerId",
                        column: x => x.WorkerId,
                        principalTable: "Workers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkerSkills_MaintenanceCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletionEvidenceUrl = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    IsEmergency = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalDecisions_MaintenanceRequestId",
                table: "ApprovalDecisions",
                column: "MaintenanceRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalDecisions_PropertyOwnerId",
                table: "ApprovalDecisions",
                column: "PropertyOwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_ExternalMaintenanceArrangements_MaintenanceRequestId",
                table: "ExternalMaintenanceArrangements",
                column: "MaintenanceRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceAreas_WorkerId",
                table: "ServiceAreas",
                column: "WorkerId");

            migrationBuilder.CreateIndex(
                name: "IX_ValidationResults_MaintenanceRequestId",
                table: "ValidationResults",
                column: "MaintenanceRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_ValidationResults_WorkerId",
                table: "ValidationResults",
                column: "WorkerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workers_VerifiedByAdminId",
                table: "Workers",
